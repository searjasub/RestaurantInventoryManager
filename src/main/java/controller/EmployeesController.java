...
public class EmployeesController {
    ...
    void setPrimaryStage(Stage primaryStage, Scene employeeScene, MainStageController mainStageController, HashMap<Integer, Employee> employeesCollection, CurrentSession currentSession) {
        ...
        primaryStage.setTitle("Restaurant Inventory Manager - Employees");
    ...
    private void updateEmployee(int id, String updateField, String updateValue) {
